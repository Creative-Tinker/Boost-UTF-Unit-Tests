#############################################################################
# Makefile for building: bin/track-tests
# Generated by qmake (3.1) (Qt 5.15.12)
# Project:  Track-Tests.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Track-Tests.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++20 -Wall -Wfatal-errors -O2 -flto -fno-fat-lto-objects -Wall -Wextra -fPIC $(DEFINES)
INCPATH       = -I. -Iheaders -Iheaders/gpx -Iheaders/xml -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = track-tests1.0.0
DISTDIR = /home/user1/SOFT/coursework2/bin/track-tests1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -pipe -std=c++20 -Wall -Wfatal-errors -O2 -flto=8 -fno-fat-lto-objects -fuse-linker-plugin -fPIC
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Track-Tests.pro headers/earth.h \
		headers/geometry.h \
		headers/track.h \
		...
		headers/xml/xml-parser.h src/earth.cpp \
		src/geometry.cpp \
		src/track.cpp \
		src/waypoint.cpp \
		src/gpx/gpx-parser.cpp \
		...
		src/xml/xml-parser.cpp \
		tests/track-tests.cpp
QMAKE_TARGET  = track-tests
DESTDIR       = bin/
TARGET        = bin/track-tests


first: all
####### Build rules

bin/track-tests:  $(OBJECTS)  
	@test -d bin/ || mkdir -p bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Track-Tests.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		Track-Tests.pro
	$(QMAKE) -o Makefile Track-Tests.pro
...
bin/track.o: src/track.cpp headers/geometry.h \
		headers/types.h \
		headers/track.h \
		headers/waypoint.h \
		headers/trackpoint.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/track.o src/track.cpp
...
bin/gpx-parser.o: src/gpx/gpx-parser.cpp headers/xml/xml-parser.h \
		headers/xml/xml-element.h \
		headers/gpx/gpx-parser.h \
		headers/trackpoint.h \
		headers/waypoint.h \
		headers/types.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/gpx-parser.o src/gpx/gpx-parser.cpp

bin/xml-element.o: src/xml/xml-element.cpp headers/xml/xml-element.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/xml-element.o src/xml/xml-element.cpp

bin/xml-parser.o: src/xml/xml-parser.cpp headers/xml/xml-element.h \
		headers/xml/xml-parser.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/xml-parser.o src/xml/xml-parser.cpp

bin/track-tests.o: tests/track-tests.cpp headers/gpx/gpx-parser.h \
		headers/trackpoint.h \
		headers/waypoint.h \
		headers/types.h \
		headers/track.h \
		headers/earth.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o bin/track-tests.o tests/track-tests.cpp
